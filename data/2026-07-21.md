...
### [24] [Revealing a multi-zone circumnuclear dust response in UGC~11487 through phase-resolved WISE W1--W2 diagnostics](https://arxiv.org/abs/2607.17815)
...
### [25] [Structural and dynamical properties of Tidal dwarf galaxies in the tails and bridge of the Guitar galaxy Arp 105](https://arxiv.org/abs/2607.17776)
...
### [26] [Testing [O II] $\lambda3727$ as a Star Formation Rate Tracer in Quasar Host Galaxies](https://arxiv.org/abs/2607.17788)
*Xiaotong Feng,Xue-Bing Wu,Yuming Fu,Yuxuan Pang,Rui Zhu,Huimei Wang*
...
### [32] [Rolling Galileons: Evolving Braiding Strength for Viable Dark Energy](https://arxiv.org/abs/2607.16395)
...
### [33] [The Goldstone Awakens: Unimodular dark energy in scale-invariant $R^2$ gravity](https://arxiv.org/abs/2607.16405)
...
### [34] [Origin of the Sloshing Spiral in the Abell 2107 Galaxy Cluster](https://arxiv.org/abs/2607.16496)
...
### [35] [Unveiling dark energy properties with high-sensitivity cross-correlations of neutral hydrogen intensity mapping and galaxy surveys](https://arxiv.org/abs/2607.17141)
...
### [36] [Microlensing of Microlensing: Effects of Random Stars on the Double-Source-Plane Gravitational Lens](https://arxiv.org/abs/2607.17144)
...
### [37] [One Year and One Night to 1% in $\mathbf{H_0}$: Efficient Spectroscopic Strategy for Dark Siren Cosmology](https://arxiv.org/abs/2607.17284)
...
### [38] [Constraints on Primordial Black Hole Dressed by Dark Matter Halo from Microlensing Effect of Fast Radio Bursts](https://arxiv.org/abs/2607.17338)
...
### [39] [Simultaneous inference of isotropic and anisotropic polarization rotation angles for next-generation cosmic microwave background experiments](https://arxiv.org/abs/2607.17500)
...
### [40] [Repulsive dark matter from Hosotani mechanism](https://arxiv.org/abs/2607.17727)
...
### [41] [Intracluster light and dark matter halo shapes reflect common assembly, not mutual coupling: shape correspondence in CDM but not SIDM](https://arxiv.org/abs/2607.17792)
...
### [42] [Magnetically assisted primordial scalar perturbations: Scalar-Induced Gravitational Waves](https://arxiv.org/abs/2607.17875)
...
### [43] [Comparing explicit likelihood and likelihood-free simulation-based inference for weak lensing cosmic shear](https://arxiv.org/abs/2607.17942)
...
### [44] [Core-Halo Mass Relation in Cosmological Vector Dark Matter](https://arxiv.org/abs/2607.18025)
...
### [45] [Biased Domain Wall Networks and their Gravitational Waves](https://arxiv.org/abs/2607.18107)
...
### [46] [Benchmarking wall velocities in cosmological phase transitions: Fluid Ansatz and WallGo](https://arxiv.org/abs/2607.18207)
...
### [47] [Breaking the $f_{\text{NL}}$--$b_φ$ degeneracy with the time evolution of tracer number counts](https://arxiv.org/abs/2607.18229)
...
### [48] [Cosmological consequences of a dynamical dark matter in the light of DESI DR2 measurements](https://arxiv.org/abs/2607.18234)
