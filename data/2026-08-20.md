...
### [5] [The MAGPI Survey: Emission Line Products Data Release and the Role of Spectroscopic Aperture Covering Fraction on the Balmer Decrement-Stellar Mass Relation](https://arxiv.org/abs/2608.18464)
...
### [6] [Continuum Variability in AGN: Evidence for Systematically Suppressed Fluctuations in the BAL Population](https://arxiv.org/abs/2608.18287)
...
### [7] [Inferring the Dark from the Observable: Estimating Halo Masses Using Galaxy Properties](https://arxiv.org/abs/2608.19154)
...
### [8] [Dynamics of tidal dwarf galaxies in the system Arp 72](https://arxiv.org/abs/2608.18385)
...
### [9] [A model for the enhanced production rate of early-type hypervelocity stars in the Galactic halo](https://arxiv.org/abs/2608.18475)
...
### [10] [Beyond Idealized PAHs: Infrared Signatures of Carbon-Chain Defects from Shock Synthesis](https://arxiv.org/abs/2608.18505)
...
### [11] [Kinematics and Dynamics of the Open Cluster NGC 2302](https://arxiv.org/abs/2608.18550)
...
### [12] [Hector Galaxy Survey: Falling in Between - Infalling Galaxies in the Midst of the Abell 3667 Merger](https://arxiv.org/abs/2608.18621)
...
### [13] [The Total and Polarized Radio Emission from the Innermost Jets of a High-Redshift Quasar and a Candidate at Parsec-Scale Resolution](https://arxiv.org/abs/2608.18691)
...
### [14] [Size-Mass Relation Shows Its Colours: Contrasting Physical Imprints of Galaxy Evolution in Rest-Frame UV and Optical](https://arxiv.org/abs/2608.18776)
...
### [15] [The efficient star-forming regions of stripped-envelope supernovae](https://arxiv.org/abs/2608.18897)
...
### [16] [The progenitors of $z\gtrsim10$ JWST galaxies in the COLIBRE simulations](https://arxiv.org/abs/2608.19007)
...
### [20] [Mapping the Information Geometry of an Unresolved Dark Matter Population using a Differentiable Strong Lensing Simulator](https://arxiv.org/abs/2608.18224)
*Alexandre Adam*
...
### [21] [Testing MOND-like modifications to gravity using growth-rate measurements and one-loop corrections to the matter power spectrum](https://arxiv.org/abs/2608.18229)
...
### [22] [CosmoPyro: Gradients for Gravitational-Wave Cosmology](https://arxiv.org/abs/2608.18281)
...
### [23] [PowerFull: fast and accurate computation of the relativistic angular galaxy power spectrum including local primordial non-Gaussianity](https://arxiv.org/abs/2608.18334)
...
### [24] [Broadband Chiral Primordial Gravitational Waves from Constant-roll Inflation in Parity-violating Symmetric Teleparallel Gravity](https://arxiv.org/abs/2608.18649)
...
### [25] [Towards end-to-end Bayesian forward models in global 21-cm cosmology: surrogate modelling and marginalisation of beam uncertainty](https://arxiv.org/abs/2608.18962)
...
### [26] [Dipolar power asymmetry in wide-angle correlations of galaxy density, velocity and ellipticity](https://arxiv.org/abs/2608.19039)
