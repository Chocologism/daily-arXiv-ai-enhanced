...
### [18] [The abundance and radial distribution of faint and ultra-faint dwarfs in galaxy clusters](https://arxiv.org/abs/2604.22920)
...
### [19] [Cluster-green galaxy correlations: where do these galaxies live?](https://arxiv.org/abs/2604.22921)
...
### [20] [Itô tracers: continuous-trajectory Lagrangian particles for Eulerian hydrodynamics](https://arxiv.org/abs/2604.23041)
...
### [21] [Analysis of a Septuple Open Cluster System and Its Extended Family in Gaia DR3](https://arxiv.org/abs/2604.23093)
...
### [22] [Hessian-based photometric substructure as an evolutionary tracer of OB cluster candidates in M31](https://arxiv.org/abs/2604.23118)
...
### [23] [The Dependence of the Mean Spectral Energy Distributions on the Accretion Rate for Quasars with $z < 0.75$ from the Sloan Digital Sky Survey](https://arxiv.org/abs/2604.23123)
...
### [24] [A graph-based Neural Network surrogate model for accelerating semi-analytical model of galaxy formation and evolution](https://arxiv.org/abs/2604.23147)
...
### [25] [Two Exciting High-redshift Galaxy Candidates Turn Out to Be Two Exciting Ultra-cool Brown Dwarfs](https://arxiv.org/abs/2604.23668)
...
### [26] [The Vertical Structure and Asymmetry of Mg ii-enriched Gas in the Milky Way Disk](https://arxiv.org/abs/2604.23686)
...
### [27] [A GLIMPSE of the 99%: a census of the faintest galaxies during the epoch reionization and its implications for galaxy formation models](https://arxiv.org/abs/2604.23823)
...
### [28] [With arms wide open: a VLT/MUSE view of the mechanisms driving unwinding spiral arms in cluster galaxies](https://arxiv.org/abs/2604.23911)
...
### [29] [East Asian VLBI Network astrometry toward the star-forming region G040.96+02.48 in the Extreme Outer Galaxy](https://arxiv.org/abs/2604.23963)
...
### [30] [Clash of the Trident and Tuning Fork: insights from bar and spiral strength in the (massive black hole)-stellar mass diagrams, and the `Triangal' galaxy evolution schema](https://arxiv.org/abs/2604.24084)
*Alister W. Graham*
...
### [31] [A Morphological Identification and Study of Radio Galaxies from LoTSS DR2. III. The Multiwavelength Analysis of Winged Radio Galaxies](https://arxiv.org/abs/2604.24111)
...
### [32] [Recovering extra-tidal open cluster members via multi-elemental chemical tagging](https://arxiv.org/abs/2604.24358)
*Andrès E. Piatti*
...
### [33] [CSST Preparations: Galaxy Completeness and Sérsic Profile Fitting across the Wide, Deep, and Extreme Fields](https://arxiv.org/abs/2604.24431)
...
### [34] [Mapping the Milky Way with Gaia Bp/Rp spectra-IV: the broken and asymmetric density profile of the stellar disk traced by a large sample of red clumps](https://arxiv.org/abs/2604.24456)
...
### [35] [Machine learning technique for morphological classification of galaxies from SDSS. IV. Visual inspection vs CNN for merging, irregular, edge-on, barred, ringed, and with dust lanes galaxies at 0.02<z<0.1](https://arxiv.org/abs/2604.24471)
...
### [36] [Probing the Hot Gaseous Halos of Milky Way-like Galaxies in the TNG50 simulation](https://arxiv.org/abs/2604.24494)
...
### [37] [Aromatic rings in the Central Molecular Zone: Benzonitrile](https://arxiv.org/abs/2604.24510)
...
### [38] [Halfway to the Peak: Kinematic Signatures of Stable Rotating Disks in Luminous Infrared Galaxies at z=0.5-0.6](https://arxiv.org/abs/2604.24711)
...
### [39] [Dynamical Modeling of the Broad-Line Region with High-Mass Active Galactic Nuclei and Constraints on the Virial Factor](https://arxiv.org/abs/2604.24721)
...
### [40] [The lifetime of 100,000 molecular clouds in the nearby Universe](https://arxiv.org/abs/2604.24759)
