...
### [5] [$Ab$ $initio$ modeling of Galactic dust polarized CMB foreground](https://arxiv.org/abs/2605.06896)
...
### [6] [Spectrally and spatially resolved (sub)millimeter HCN-to-HCO$^{+}$ flux ratios in nearby ultraluminous infrared galaxies](https://arxiv.org/abs/2605.06842)
...
### [7] [$V/σ$ Trends with Mass for Dwarf Galaxies from the Marvelous Massive Dwarfs Suite](https://arxiv.org/abs/2605.06893)
...
### [15] [Dark siren cross-correlations and the sensitivity of $H_0$ to methodological choices](https://arxiv.org/abs/2605.06783)
...
### [16] [On the origin of the environmental step: A BayeSN view of the ZTF SN Ia DR2](https://arxiv.org/abs/2605.06799)
...
### [17] [CMB Limits on the Absorption of Light Vector and Axial-Vector Dark Matter](https://arxiv.org/abs/2605.08080)
