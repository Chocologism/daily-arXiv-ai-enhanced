...
### [1] [Chemo-dynamical Analysis of a CNO-Enhanced Ultra Metal-poor Star ($\rm[Fe/H] < -4$): Insights into Early Enrichment by Faint Population III Supernova](https://arxiv.org/abs/2609.13373)
...
### [2] [Mapping parameters of idealised hydrodynamic galaxy simulations to bar properties: a case study with the RAMSES code](https://arxiv.org/abs/2609.13404)
...
### [3] [The New Dark Matter Density Profile from JWST JADES Galaxies](https://arxiv.org/abs/2609.14071)
...
### [4] [Decoding RR Lyrae light curves with deep learning for accurate absolute magnitude estimation](https://arxiv.org/abs/2609.14342)
...
### [7] [Tracing Stellar Populations through the Mg-Al Anti-Correlation in Gaia-ESO Globular Clusters](https://arxiv.org/abs/2609.14901)
...
### [8] [Nexus-CDM: Isolated Galaxy Simulations with Cosmologically Evolving Dark-Matter Halos I. Method and Validation](https://arxiv.org/abs/2609.15002)
...
### [9] [The GMRT CAT$z$1-COSMOS Survey: HI 21 cm emission from star-forming galaxies at $z\approx1$ in the COSMOS field](https://arxiv.org/abs/2609.13382)
...
### [10] [Rubin Observatory Reveals a Dust-Shrouded Halo Globular Cluster in Ophiuchus](https://arxiv.org/abs/2609.15872)
...
### [11] [Complete Second-Order Relativistic Derivation of the Observed Pulsar Timing Modulations](https://arxiv.org/abs/2609.13364)
...
### [12] [CHEX-MATE: X-ray surface brightness discontinuities across a representative cluster sample](https://arxiv.org/abs/2609.13610)
...
### [13] [Gravitational-Wave Image Multiplicity as a Topological Probe of Dark-Matter Core Collapse](https://arxiv.org/abs/2609.15462)
...
### [14] [Anisotropic redshift distributions in photometric galaxy clustering and their cosmological impact](https://arxiv.org/abs/2609.15542)
...
### [15] [Toward Precision Kinetic Sunyaev-Zel'dovich Cosmology---1. The Matter - Momentum Bispectrum at One-Loop Order](https://arxiv.org/abs/2609.15750)
...
### [16] [Using the Circumgalactic Medium of Dwarf Galaxies as a Calorimetric Dark Matter Detector](https://arxiv.org/abs/2609.15748)
