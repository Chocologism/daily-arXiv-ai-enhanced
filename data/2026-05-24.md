...
### [6] [Towards precision cosmology with Void x CMB correlations (II): Impact of mock catalogs on the Void x CMB lensing signal](https://arxiv.org/abs/2605.22630)
...
### [7] [Primordial black holes in excursion set theory: Formation probabilities, mass functions, and window functions](https://arxiv.org/abs/2605.22789)
...
### [9] [(LRDs)$^2$: The Low-ReDshift Little Red Dots Survey. II. DESI DR1 Sample](https://arxiv.org/abs/2605.21574)
...
### [10] [Investigating central star formation in local AGN host galaxies: is there tension between coeval growth and AGN feedback?](https://arxiv.org/abs/2605.21576)
...
### [11] [Decomposing cool stellar populations with H-band spectral fluctuations: Long-period variable stars in NGC 5128 and carbon stars in NGC 5102](https://arxiv.org/abs/2605.21588)
...
### [13] [Predicting intermediate-mass black hole formation in star clusters with machine learning](https://arxiv.org/abs/2605.21593)
...
### [15] [JWST Advanced Deep Extragalactic Survey (JADES) Data Release 5: stellar population catalogue for galaxies in GOODS-N and GOODS-S](https://arxiv.org/abs/2605.21599)
...
### [16] [An AGN in the Antennae galaxies ?](https://arxiv.org/abs/2605.21879)
...
### [17] [Silicate cosmic dust grain collisions in the interstellar medium: A molecular dynamics study](https://arxiv.org/abs/2605.22225)
...
### [18] [MICONIC: The multiphase circumnuclear region of Centaurus A as seen with JWST/MIRI MRS observations. I. Spectral inventory and properties of the warm molecular disk](https://arxiv.org/abs/2605.22497)
...
### [19] [The habitability trade-off: Chemical decoupling and quenching in massive galaxies](https://arxiv.org/abs/2605.22510)
...
### [20] [Probing the ion-neutral drift velocity towards the L1544 prestellar core: Detection of ambipolar diffusion using N$_2$D$^+$ and para-NH$_2$D](https://arxiv.org/abs/2605.22541)
...
### [21] [Dwarf Galaxy Constraints on Interacting Fermionic Dark Matter](https://arxiv.org/abs/2605.22685)
...
### [23] [Mass Segregation in the CMZoom Survey](https://arxiv.org/abs/2605.22754)
